...
@section('title', 'Loan Payment Calculator - Free Online')
@section('meta_description', 'Free Calculate monthly loan payments and total cost. Step-by-step solutions and formulas included.')
@section('canonical', config('site.url') . '/finance/loan-payment-calculator')
...
<div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <p class="text-lg text-gray-600 mb-8">Calculate monthly loan payments and total cost.</p>

    <div x-data="loanPaymentCalculator()" class="bg-white rounded-2xl border border-gray-200 shadow-sm p-6 mb-12">
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
            <div>
                <label class="block text-sm font-medium text-gray-700 mb-1">Loan Amount ($)</label>
                <input type="number" x-model.number="principal" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500" placeholder="25000">
            </div>
            <div>
    ...
    <div class="max-w-3xl">
        ...
        <p class="text-gray-600 leading-relaxed mb-4">Calculate monthly loan payments and total cost. This calculator provides instant results with step-by-step explanations to help you understand the calculation process.</p>
...
this.steps = 'Monthly: $' + m.toFixed(2) + '\nTotal: $' + (m*n).toFixed(2) + '\nInterest: $' + (m*n-this.principal).toFixed(2);
