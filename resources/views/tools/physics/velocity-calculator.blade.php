@extends('layouts.app')
@section('title', 'Velocity Calculator')
@section('meta_description', 'Calculate velocity using initial velocity, acceleration, and time.')
@section('canonical', config('site.url') . '/physics/velocity-calculator')

@section('schema')
<script type="application/ld+json">
{"@context":"https://schema.org","@type":"SoftwareApplication","name":"Velocity Calculator","applicationCategory":"EducationalApplication","operatingSystem":"Web","offers":{"@type":"Offer","price":"0","priceCurrency":"USD"}}
</script>
@endsection
...
<div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    <nav aria-label="Breadcrumb" class="mb-6">
        <ol class="flex items-center gap-2 text-sm text-gray-500">
            ...
            <li><svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/></svg></li>
            <li class="text-gray-900 font-medium">Velocity Calculator</li>
        </ol>
    </nav>

    <h1 class="text-3xl lg:text-4xl font-bold text-gray-900 mb-2">Velocity Calculator</h1>
    <p class="text-lg text-gray-600 mb-8">Calculate velocity using initial velocity, acceleration, and time.</p>

    <div x-data="velocityCalculator()" class="bg-white rounded-2xl border border-gray-200 shadow-sm p-6 mb-12">
    ...
    <div class="max-w-3xl">
        <h2 class="text-2xl font-bold text-gray-900 mb-4">Understanding Velocity Calculator</h2>
        <p class="text-gray-600 leading-relaxed mb-4">The velocity equation v = v₀ + at is one of the fundamental kinematic equations for uniformly accelerated motion.</p>
        <div class="bg-gray-50 rounded-lg p-4 mb-6 text-center"><p class="formula-block">$$v = v_0 + at$$</p></div>
...
function velocityCalculator() {
    return {
        ...
        calculate() {
            this.error = '';
            this.result = null;
            let v0=parseFloat(this.v0)||0,a=parseFloat(this.a),t=parseFloat(this.t);if(isNaN(a)||isNaN(t)){this.error="Enter valid values";return;}this.result=v0+a*t;this.resultText="v = "+this.result.toFixed(4)+" m/s";this.steps=[{title:"Given",text:"v₀="+v0+" m/s, a="+a+" m/s², t="+t+" s"},{title:"v = v₀ + at",text:"v = "+v0+" + "+a+"×"+t+" = "+this.result.toFixed(4)+" m/s"}];
        }
    };
}
</script>
